...
- [x] [IMLE-Net 多尺度多通道ECG分类模型 (IEEE SMC'2021)](https://github.com/likith012/IMLE-Net)
- [x] [RNN-Lyapunov Exponent心律失常分类](https://github.com/YeongHyeon/Arrhythmia_Detection_RNN_and_Lyapunov)
- [x] [心律失常分类 (TOP 1 in PysioNet'2018)](https://github.com/ChihHanHuang/Deep-learning-ECG-The-China-Physiological-Signal-Challenge-2018-champion)
...
- [x] [房颤分类模型 (TOP 1 in PhysioNet'2017)](https://github.com/hsd1503/ENCASE)
...
- [x] [*STEMI急性心肌梗死检测](https://github.com/YeongHyeon/Preprocessing-Method-for-STEMI-Detection)
- [x] [18导联心肌梗死检测](https://github.com/ragilhadi/myocardial-infraction-detection)
- [x] [分类模型 (PhysioNet'2020)](https://github.com/hsd1503/python-classifier-2020)
- [x] [ECG心跳分类](https://github.com/MousaviSajad/ECG-Heartbeat-Classification-seq2seq-model)
...
- [x] [TOP 1 in 合肥ECG比赛'2019](https://github.com/zhengqi98/Hefei_ECG_TOP1)
...
- [x] [ECGNet复现：定位R和P波](https://github.com/busyyang/ECGNet)
...
- [x] [基于SE-attention的ECG分类网络(ICASSP'2019）](https://github.com/Amadeuszhao/SE-ECGNet)
...
- [x] [基于条件约束的ECG分类（CinC'2020）](https://github.com/Bsingstad/PhysioNet-CinC-Challenge2020-TeamUIO)
...
- 其它数据
	 ...
	 - [x] [用于药物试验的ECG数据集-1](https://www.physionet.org/content/ecgdmmld/1.0.0/)
	 - [x] [用于药物试验的ECG数据集-2](https://www.physionet.org/content/ecgrdvq/1.0.0/)
